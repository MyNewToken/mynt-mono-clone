import { r as registerInstance, h, H as Host, a as getElement, c as createEvent } from './index-a05ac311.js';
import { g as getIonMode, c as config, a as isPlatform } from './ionic-global-f84a4429.js';
import { g as getTimeGivenProgression } from './cubic-bezier-ed243a9b.js';
import { a as assert, c as componentOnReady, d as debounce } from './helpers-d7db4cd7.js';
import { l as lifecycle, t as transition, s as setPageHidden, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE } from './index-c7c874f7.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./tap-click-748024cb.js').then(module => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-35aa985b.js').then(module => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-4731c8fa.js').then(module => module.startInputShims(config));
        }
...
let Nav = class {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import('./swipe-back-6477cdbb.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
...
export { App as ion_app, Nav as ion_nav, Route as ion_route, Router as ion_router, MyntRoot as mynt_root };
