...
let MyntPage = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("ion-grid", null, index.h("ion-row", null, index.h("ion-col", { class: "-side", size: "3" }, index.h("slot", { name: "side" })), index.h("ion-col", { class: "-main", size: "9" }, index.h("slot", { name: "main" }))))));
  }
};
...
let MyntPost = class {
  ...
  render() {
    return (index.h("ion-card", null, index.h("ion-card-header", null, index.h("ion-item", null, index.h("profile-pic", { source: this.profPicSrc }), index.h("ion-card-title", null, this.name)), index.h("ion-card-subtitle", null, this.user)), index.h("ion-card-content", null, this.text), index.h("ion-card-content", null, index.h("ion-thumbnail", null, index.h("ion-img", { src: this.mediaPicSrc }))), index.h("ion-item", null, index.h("ion-button", { slot: "start" }, index.h("ion-icon", { name: "thumbs-up-outline" })), index.h("ion-button", { slot: "start", onClick: () => this.presentComments() }, index.h("ion-icon", { name: "chatbox-outline" })), index.h("ion-button", { slot: "start" }, index.h("ion-icon", { name: "repeat-outline" })), index.h("ion-button", { slot: "end" }, "Tip"), index.h("ion-button", { slot: "end" }, "Buy Coin"))));
  }
};
...
let MyntSideList = class {
  ...
  render() {
    return (index.h("ion-card", null, index.h("ion-list", null, index.h("ion-list-header", null, index.h("h1", null, this.ttle)), index.h("mynt-side-listing", { image: "https://pbs.twimg.com/profile_images/1401837042934468611/okzqIoMb_400x400.jpg", text: "Logan" }), index.h("mynt-side-listing", { image: "https://pbs.twimg.com/profile_images/1401837042934468611/okzqIoMb_400x400.jpg", text: "Logan 1" }), index.h("mynt-side-listing", { image: "https://pbs.twimg.com/profile_images/1401837042934468611/okzqIoMb_400x400.jpg", text: "Logan 2" }))));
  }
};
...
let MyntSideListing = class {
  ...
  render() {
    return (index.h("ion-item", null, index.h("profile-pic", { source: this.image }), index.h("ion-card-title", null, this.text)));
  }
};
...
exports.mynt_grid_row = MyntGridRow;
exports.mynt_page = MyntPage;
exports.mynt_post = MyntPost;
exports.mynt_side_list = MyntSideList;
exports.mynt_side_listing = MyntSideListing;
