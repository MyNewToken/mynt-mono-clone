...
let MyntAssets = class {
  ...
  render() {
    return (index.h("mynt-page", null, index.h("ion-card", { slot: "side" }, index.h("h1", null, "Recently Purchased")), index.h("mynt-side-list", { ttle: "Wallet", slot: "side" }), index.h("mynt-side-list", { ttle: "Tokens", slot: "side" }), index.h("mynt-side-list", { ttle: "Physical", slot: "side" }), index.h("mynt-side-list", { ttle: "Digital", slot: "side" }), index.h("ion-content", { slot: "main" }, index.h("ion-list", null, this.data.map(item => index.h("ion-item", null, item))), index.h("ion-infinite-scroll", { ref: el => this.infiniteScroll = el, onIonInfinite: (ev) => this.loadData(ev) }, index.h("ion-infinite-scroll-content", { loadingSpinner: "bubbles", loadingText: "Loading more data..." })))));
  }
};
MyntAssets.style = myntAssetsCss;

exports.mynt_assets = MyntAssets;
