import { r as registerInstance, n as Build, i as h, j as Host, k as getElement } from './index-beea9e3c.js';
import { a as isPlatform, c as config, g as getIonMode } from './ionic-global-28a89d59.js';
    ...
    if (Build.isBrowser) {
      rIC(async () => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./tap-click-1f368e65.js').then(module => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-29974fd3.js').then(module => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-77b85a71.js').then(module => module.startInputShims(config));
        }
